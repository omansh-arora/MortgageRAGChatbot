(function () {
  ...
  const CONFIG = {
    ...
    // Example: 'https://mortgagebot-backend-abc123.onrender.com'
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .chat-toggle-btn {
        ...
        height: 64px;
        border-radius: 22px;
        background: radial-gradient(circle at 0 0, #93c5fd, #2563eb 40%, #1d4ed8 100%);
        border: none;
        box-shadow:
      ...
      .chat-messages {
        flex: 1;
        overflow-y: scroll;
        padding: 16px 18px 20px;             /* PADDING FOR BUBBLES */
      ...
      .chat-input-container {
        padding: 10px 14px 12px 12px;             /* SPACE ABOVE INPUT */
        background: #f9fafb;
